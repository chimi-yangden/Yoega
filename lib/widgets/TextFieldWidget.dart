...
class TextFieldWidget extends StatelessWidget{
  ...
  TextFieldWidget(String label,TextInputType inputType, Widget icon,
      {bool obscure=false, Color textColor = Colors.black, String fontFamily = "SFUIDisplay", double fontSize = 15,this.validator,this.onSaved}){
...
class TextFieldForm extends StatelessWidget{
  ...
  TextInputType keyboardType;
  TextFieldForm(this.hintText,this._status, this.myFocusNode,{bool expands:false, TextInputType keyboardType:TextInputType.text,int maxLines: 1, int minLines:1}){
